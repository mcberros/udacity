...
class Problem1Handler(webapp2.RequestHandler):
	...
	if not (month and day and year):
		...
		self.redirect("/problem1/thanks")

class ThanksHandler(webapp2.RequestHandler):
	def get(self):
	    self.response.out.write("Thanks") 

app = webapp2.WSGIApplication([('/problem1/birthday', Problem1Handler),('/problem1/thanks',ThanksHandler)], debug=True)
